...
> 🪧 **Note:** 
- Make sure to replace fictional-disco-g74wxjgv56rc5x7 with your codespace name.
...
> 2. Update #file:octofit-tracker/backend/octofit_tracker/views.py to replace the return for the REST API URL endpoints with the codespace URL https://fictional-disco-g74wxjgv56rc5x7-8000.app.github.dev for Django and avoid certificate HTTPS issues.
> 3. Make sure the Django backend works on fictional-disco-g74wxjgv56rc5x7-8000.app.github.dev and localhost:8000.
